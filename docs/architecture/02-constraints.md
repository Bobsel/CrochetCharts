...
- **Friend class for I/O** — `Cell`, `Scene`, `MainWindow`, `CrochetTab`, `Indicator` declare `friend class File_v1/v2/FileFactory/SaveFile`. Encapsulation is intentionally pierced by the serializers. See [08-crosscutting.md § Serialization](08-crosscutting.md#friend-based-serialization).
