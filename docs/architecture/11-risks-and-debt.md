...
| D-6 | **Hardcoded Windows paths** `C://qt//4.8.5//bin`, `C://MinGW-4.4//bin`. | `src/CMakeLists.txt` | Medium | Move to CMake cache variables with defaults, or document as local patches. |
